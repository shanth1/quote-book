    ...
    return (
        <div className="">
            <Select
                ...
                classNames={{
                    menuButton: () =>
                        "flex rounded-lg text-sm text-gray-500 bg-gray-50 border border-gray-300 transition-all duration-300 focus:outline-none hover:border-gray-400 focus:border-primary-500",
